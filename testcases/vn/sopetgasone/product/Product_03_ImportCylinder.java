...
public class Product_03_ImportCylinder extends AbstractTest {
	...
	@Test
	  public void TC_Product_07_ImportWithValidFile() {
		  log.info("************* TC07 - IMPORT VALID CYLINDER  **************");
		  
		  log.info("TC_Product_07_ImportWithValidFile - Step 01 --> Open Import Cylinder Page");
		  importCylinderPage = homePage.openImportCylinderPage(driver);
		  
		  log.info("TC_Product_07_ImportWithValidFile - Step 02 --> Upload file import with empty cylinder code");
		  importCylinderPage.sendKeyToImportCylinder(validFilePath);
		  
		  importCylinderPage.scrollToContinueButton();
		  
		  log.info("TC_Product_07_ImportWithValidFile - Step 03 --> Click to Continue Button");
		  importCylinderPage.clickToContinueButton();
		  
		  log.info("TC_Product_07_ImportWithValidFile - Step 04 --> Click choose driver");
		  importCylinderPage.selectDriverName();
		  
		  log.info("TC_Product_07_ImportWithValidFile - Step 04 --> Input to license plate");
		  importCylinderPage.inputToLicensePlate("51G-6868");
		  
		  log.info("TC_Product_07_ImportWithValidFile - Step 05 --> Click to Save button");
		  importCylinderPage.clickToSaveButton();
		  
		  log.info("TC_Product_07_ImportWithValidFile - Step 07 --> Verify import success : " + sucess_message);
  ...
  @Test
  public void TC_Product_08_ImportWithInvalidCylinder(){
	  importCylinderPage.refreshPage();
	  log.info("************* TC08 - IMPORT INVALID CYLINDER  **************");
	  
	  log.info("TC_Product_08_ImportWithInvalidCylinder - Step 01 --> Open Import Cylinder Page");
	  importCylinderPage = homePage.openImportCylinderPage(driver);
	  
	  log.info("TC_Product_08_ImportWithInvalidCylinder - Step 02 --> Upload file import with invalid cylinder code");
	  importCylinderPage.sendKeyToImportCylinder(invalidCodeFilePath); 
	  
	  log.info("TC_Product_08_ImportWithInvalidCylinder - Step 03 --> Verify message failed with invalid cylinder code: " + invalid_message);
  ...
  @Test
  public void TC_Product_09_ImportWithEmptyFile() {
	  log.info("************* TC07 - IMPORT EMPTY CYLINDER  **************");
	  
	  log.info("TC_Product_09_ImportWithEmptyFile - Step 01 --> Open Import Cylinder Page");
	  importCylinderPage = homePage.openImportCylinderPage(driver);
	  ...
	  log.info("TC_Product_07_ImportWithEmptyFile - Step 03 --> Verify message failed with invalid cylinder code " + notfound_message);
